...
<body class="bg-gray-100">
        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            @auth
                <nav class="flex items-center gap-2">
                    <a href="{{ route('posts.create') }}"
                        class="flex items-center gap-2 p-2 bg-white border text-gray-600 rounded text-sm uppercase font-bold cursor-pointer">
            ...
            @guest
                <nav class="flex gap-2 items-center">
                    ...
                    <a class="font-bold uppercase text-gray-600 text-sm" href="{{ route('register.index') }}">Crear
                        cuenta</a>
                </nav>
            @endguest
    ...
    <main class="container mx-auto bg-red p-5">
